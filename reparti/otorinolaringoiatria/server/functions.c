...
*/
void invia_date_disponibili(int sock, char *prestazione, sem_t *sem_disponibilita)
{
	int i,count=0,n;
	struct appuntamento appuntamento_da_inviare;
	struct disponibilita *lista_disponibilita;
	sem_wait(sem_disponibilita);
	read_from_db(&lista_disponibilita,&n); //Recupera dal file le disponibilita del reparto
...
*/
int conferma_appuntamento(int sock, struct prenotazione prestazione_da_prenotare, sem_t *sem_disponibilita)
{
...
*/
void inserisci_prenotazione_in_agenda(int sock, sem_t *sem_prenotazioni)
{
	int i,n, conferma = 1;
...
*/
void cancella_prenotazione(int sock, sem_t *sem_disponibilita, sem_t *sem_prenotazioni)
{
