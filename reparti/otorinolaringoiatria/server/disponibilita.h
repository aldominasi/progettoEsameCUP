...
#define LISTA_TUTTE_PRENOTAZIONI 8//INVIA LA LISTA DI TUTTE LE PRENOTAZIONI PRESENTI IN RADIOLOGIA
#define EXIT -1
...
void invia_date_disponibili(int, char *, sem_t *);
int conferma_appuntamento(int, struct prenotazione, sem_t *);
void inserisci_prenotazione_in_agenda(int sock, sem_t *);
...
void cancella_prenotazione(int sock,sem_t *,sem_t *);
